...
python main.py -n 1 -name cnn_mnist_model_var_bitwidth_exp >logs/python12.2.log 2>&1 &
python main.py -n 2 -name cnn_mnist_model_var_prune_rate_exp >logs/python13.1.log 2>&1 
