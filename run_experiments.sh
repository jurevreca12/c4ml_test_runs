...
python main.py -n 1 -name conv_layer_var_input_ch_exp >logs/python4.log 2>&1 &
python main.py -n 1 -name conv_layer_var_output_ch_exp >logs/python5.log 2>&1 &
...
python main.py -n 1 -name cnn_mnist_model_var_bitwidth_exp >logs/python12.log 2>&1 & 
python main.py -n 1 -name cnn_mnist_model_var_prune_rate_exp >logs/python13.log 2>&1 & 
